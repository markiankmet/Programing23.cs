...
namespace Lab_2
{
    ...
    static class Validation
    {
        ...
        public static DateOnly Check_last_repaired(string last_repaired_at)
        {
            DateOnly return_value;
            while (true)
            {
                bool check_input = DateOnly.TryParseExact(last_repaired_at, "dd.MM.yyyy", out return_value);
                if (check_input)
                {
                    return return_value;
                }
        ...
        public static DateOnly Check_bought_at(string bought_at, DateOnly last_repaired_at)
        {
            DateOnly return_value;
            while (true)
            {
                bool check_input = DateOnly.TryParseExact(bought_at, "dd.MM.yyyy", out return_value);
